...
EMAIL_CC          = os.environ.get("EMAIL_CC", "")  # Diana, Brittany, Erica — CC on all client emails
MANAGER_EMAIL     = os.environ.get("MANAGER_EMAIL", EMAIL_CC.split(",")[0].strip() if EMAIL_CC else "")  # Erica — direct notifications
